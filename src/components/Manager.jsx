      ...
      <div className="w-full max-w-4xl bg-slate-800 rounded-xl shadow-2xl overflow-hidden border border-slate-700/50">
        ...
        <div className="text-white p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-slate-700 rounded-lg px-5 py-4 text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-green-400 transition duration-200 border border-slate-600/20"
                />
                <span className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-green-400 cursor-pointer transition duration-200">
          ...
          <div className="flex justify-center mt-8">
            <button className="flex items-center gap-2 bg-green-400 hover:bg-green-500 text-slate-900 font-medium py-3 px-8 rounded-lg transition duration-200 shadow-lg hover:shadow-xl active:bg-green-600 active:translate-y-0.5">
              <FaPlus size={16} />
              Add Password
            </button>
          </div>
